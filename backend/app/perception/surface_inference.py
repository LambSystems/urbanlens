...
def infer_surface(
    ...
    if hotspot_type == HotspotType.other:
        return {"material_type": "unclassified_surface", "material_confidence": 0.30}

    if hotspot_type == HotspotType.vegetation_loss:
        return {"material_type": "vegetation", "material_confidence": round(0.60 + green_ratio * 0.30, 2)}

    if hotspot_type == HotspotType.hvac_mechanical:
        return {"material_type": "metal_equipment", "material_confidence": round(0.68 + light_ratio * 0.20, 2)}
