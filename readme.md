...
Hosted portfolio deploys should use `DEMO_MODE=true`; Railway auto-installs the lightweight `backend/requirements.txt`. Full local ThermalGen/PyTorch dependencies live in `backend/requirements-full.txt`.
